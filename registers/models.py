...
class Users(AbstractBaseUser):
    ...
    surnames = models.CharField('Apellidos',max_length=150)
    ...
    email = models.EmailField('Correo', blank=True, null=True, unique=True)
...
class Book(models.Model):
    ...
    state = models.BooleanField('Estado',default=True)
    stock = models.IntegerField('Cantidad', blank=True, null=True, default=1)
    borrowed = models.IntegerField('Prestados', blank=True, null=True, default=0)
